$(document).ready(function(){
    var $faq =[
        ["HOW CAN I BECOME AN INVESTOR OF THE INVESTPLAN LTD?",`Firstly, you must register. Fill out the registration form. We recommend you to specify only true data. Create a login, a password and specify your 
        ...
        account, choose the investment plan, make a deposit, etc "Registration".`],
        ["What electronic payment systems can I use for financial operations?",`We work with the following electronic payment systems: Perfect Money, Payeer, Bitcoin, Ethereum, Litecoin, Dash and Dogecoin. 
        ...
        ["CAN I CHANGE MY PASSWORD, PAYMENT DETAILS AND EMAIL?",`You can change your password yourself in your profile. You can also change payment wallet you use to make payments only through the project 
        administrator by making a request via one of the contacts specified on the website. However, you can not change your email.`],
        ["HOW CAN I WITHDRAW MY PROFIT?",`Depending on the investment plan you chose, the profit is formed from the accrual percent and deposit. As soon as funds are credited to your 
        ...
        ["DO YOU CHARGE ANY HIDDEN FEES FROM WITHDRAWALS?",`Some payment processors charge some fees:
        - PerfectMoney: 0.5%
        - Payeer: 0.95%
